...
<!-- BEGIN AUTO SUMMARY -->
## Auto Summary
- Updated: 2026-04-08 22:50 UTC
- Total logged runs: 289
...
- Last run: `exp361` | CANDIDATE | score 0.613 | apr08-vast4090 15m infra reset soft slow-tf ranking
...
- Last promising run: `exp361` | score 0.613 | apr08-vast4090 15m infra reset soft slow-tf ranking
- Recent keep rate: 0.00% over the last 20 runs
- Recent progress rate: 35.00% over the last 20 runs
- Runs since best: 91
- Suggested mode: `exploit`
- Revert-heavy themes: apr08, vast4090, 15m, campaign, control
- Keep-heavy themes: apr08, vast4090, 15m, campaign, push_relax
