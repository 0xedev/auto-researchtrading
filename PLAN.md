...
- Deriv live/demo map was expanded on `2026-04-28` after public `contracts_for` metadata confirmed `CRASH300N` and `BOOM300N` support `MULTUP`/`MULTDOWN` with multiplier range `[20, 40, 60, 80, 100]`; defaults use conservative `x20`.
