...
uv run fetch_alphaxiv.py     # discover new quant papers from arXiv/alphaxiv → merges into docs/knowledge.json (requires GOOGLE_API_KEY, optional ALPHAXIV_TOKEN)
```
